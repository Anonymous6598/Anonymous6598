...
class Program(CTk):
	...
	def __init__(self, *args, **kwargs) -> None:
		...
		self.main_screen_taskbar_exit_button = CTkButton(master=self.main_screen_taskbar, text="↵", height=20, width=10, corner_radius=5, fg_color="green")
	...
	def __close_taskbar__(self, event) -> None:
		self.main_screen_taskbar_button.grid(column=0, row=0)
