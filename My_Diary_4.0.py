...
class Program(CTk):
	def __init__(self, *args, **kwargs) -> CTk:
		...
		self.main_screen_undo_button.grid(column=2, row=0)
		...
		self.main_screen_redo_button.grid(column=3, row=0)
		...
		self.main_screen_settings_button.place(x=2, y=207)
	...
	def __frame_resize__(self, event):
	...
	def __edit_text_font__(self, configure):
		...
		elif self.main_screen_edit_overstrike_button_data == "overstriked":		
	...
	def __change_text_color__(self, pickle):
	...
	def __change_text_field_color__(self, pickle):
	...
	def __change_text_field_text_height__(self, pickle):
	...
	def __change_button_color__(self, picle):
	...
	def __program_version__(self, event):
		if self.language_data == "Српски":
			showinfo(title="Version_info", message="версија: 4.0")

		elif self.language_data == "English":
			showinfo(title="Version_info", message="version: 4.0")

		elif self.language_data == "Русский":
			showinfo(title="Version_info", message="версия: 4.0")
...
class Program_taskbar(CTkFrame):
	def __init__(self, master=any, width=300, height=791, border_width=0, corner_radius=5, fg_color="transparent") -> CTkFrame:
...
if __name__ == "__main__":
	...
	showwarning(title="anticrack", message="the code has been stolen")